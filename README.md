...
```
cd existing_repo
git remote add origin https://git.w-hs.de/id_sti/sti_workerthread.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.w-hs.de/id_sti/sti_workerthread/-/settings/integrations)
